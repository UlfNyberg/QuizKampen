...
public class HomescreenGUI extends JPanel {
    ...
    ImageIcon bild6 = new ImageIcon(new ImageIcon ("src/GUI/welcomePicture.jpg").getImage().getScaledInstance(220,340, Image.SCALE_DEFAULT));
    ...
    ImageIcon gameNameTopImage = new ImageIcon(new ImageIcon ("src/GUI/gameNameTop.png").getImage().getScaledInstance(250,250, Image.SCALE_DEFAULT));


    JLabel imagePanel = new JLabel(new ImageIcon("src/GUI/gameNameTop.png"));
