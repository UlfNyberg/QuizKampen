...
public class CurrentResultGUI extends JPanel {
    ...
    public CurrentResultGUI(ActionListener al) {
        ...
        round1Button.addActionListener(al);
        round2Button.addActionListener(al);
        round3Button.addActionListener(al);
        round4Button.addActionListener(al);
        round5Button.addActionListener(al);
